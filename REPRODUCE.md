...
```
My connection to the ZTL / a downstream consumer project:  none  (or: acquaintance / relative / colleague)
Date:
...
**Tier 1** — a reproducer with no prior connection to ZTL or a downstream consumer (maximal
