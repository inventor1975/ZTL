...
if __name__ == "__main__":
    ...
    print()
    print("  ZTL|K3 is 0.000 on rules HERE and 0.089 on laws. CAUTION,")
    print("  corrected 2026-07-21 by pssl/ztl_vs_k3.py: the 0.000 is a")
    print("  DEPTH-1 POOL ARTIFACT. This pool has no ¬¬p-shaped premises,")
    print("  which are exactly what separates them — on the depth-2 pool")
    print("  the single-premise consequence relations diverge on 57,902")
    print("  pairs and are INCOMPARABLE. So ZTL and K3 do NOT have identical")
    print("  transport; they merely look identical where the pool is too")
    print("  shallow to ask ¬¬p ⊨ p. The earlier 'same transport, different")
    print("  theorems' reading was the day's shallow-pool blindness, in our")
    print("  own committed result — see ztl_vs_k3.py for the two witnesses.")
