# -*- coding: utf-8 -*-
"""
zsew_compose — does the seam actually compose? The properties the external reviewer's
...
if __name__ == "__main__":
    print("=" * 76)
    print("DOES THE SEAM COMPOSE? — the external reviewer's properties, measured")
    print("=" * 76)
    ...
    print("    the external reviewer's concern: every pair sews, yet the whole set")
    ...
    print("    where an accumulating join-context would be needed (the external reviewer).")
    ...
    if not assoc:
        ...
        print("  seam, exactly as the external reviewer warned. This is the measured case")
