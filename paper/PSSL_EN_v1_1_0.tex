...
resolutions of one diagonal, (ii) three machine-checked components
(\S\ref{sec:mirror}) --- the two complementary poles and the combinatorial
core of contextuality --- and (iii) a closing reading (\S\ref{sec:world}),
marked as such.
