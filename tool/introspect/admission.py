...
Замысел (memo Аркадия 2026-08-25 + план admission-v0.2): между «источник
...
Инварианты, что кодируем механически (из G1..G12 Аркадия — дешёвые):
...
def _selftest() -> int:
    ...
    c = build_certificate("Порог памяти 64 ГиБ.", "VERAXIS", "ruleX", atoms,
    ...
    import guards as _g
    c_v = build_certificate("Порог памяти 64 ГиБ.", "VERAXIS", "ruleX", atoms,
                            "T", "retrieval", "multi@k=5", ep,
                            guard_vocab_digest=_g.VOCAB_DIGEST)
    c_w = build_certificate("Порог памяти 64 ГиБ.", "VERAXIS", "ruleX", atoms,
                            "T", "retrieval", "multi@k=5", ep,
    ...
    c2 = build_certificate("Порог 128 ГиБ.", "VERAXIS", "ruleX", atoms,
    ...
    c3 = build_certificate("Порог 128 ГиБ.", "VERAXIS", "ruleX", atoms,
