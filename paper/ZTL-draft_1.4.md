...
and the frame's own mini-theorems, twenty-nine modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 428 theorems, each one audited individually rather than by
...
line reads otherwise. **428 of 428 clean**, re-run by CI on every push.
