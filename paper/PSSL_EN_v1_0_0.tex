...
with four machine-checked components}
...
composition --- and record them as four machine-checked components in Lean~4 on the \emph{empty axiom list} (no
...
resolutions of one diagonal, (ii) four machine-checked components
...
Author's & ZTL, the zero-trust paracomplete logic~\cite{ztl}; the arrangement of the four as resolutions of one diagonal; the four Lean witnesses on the empty axiom list (the two poles, the contextuality core, the junction theorem); the measured ladder of falls and its saturation & synthesis + machine-checked \\
