...
zverify.grade), exactly one thing and its exact boundary:
  ...
  for a downstream consumer), which ZTL is not and does not claim to be.
...
# --- the ADMIT formula (curator's / a downstream consumer spec) ----------------------
...
# --- the grounding layer (models a downstream consumer; NOT ZTL) --------------------
