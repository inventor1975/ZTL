...
нуле аксиом: чистое вычисление и конструктивная логика ядра. Несформа-
лизована лишь эквивалентность движка-на-базисе и «родных» правил →,⊕,↔
из §5 (их точность покрыта cover_*-теоремами, совпадение решений —
2490 сверок).
