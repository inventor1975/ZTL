...
kernel and belongs to the grounding layer (a downstream consumer):
...
- **Grounding layer (a downstream consumer)** — proves the grounds are current,
...
Prior contact with the a downstream consumer/VRG author (no active collaboration). This
