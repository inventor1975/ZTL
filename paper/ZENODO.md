...
`test_numeric_names.py`, `test_numbers_need_values.py`, `test_quadratic.py`, `test_solver_logic.py`, `test_solver_provenance.py`, `test_bound_products.py`, `test_unknown_marks.py`, `test_multilinear.py`, `test_higher_degree.py`, `test_catalogue_equations.py` (24.09) и `test_int_refine.py` (25.09), и в дереве их 158. Запись на Zenodo неизменна и верна о себе;
...
clones self-contained (the repository regression is 158 stands here, the
...
regression (158 test stands). As of v2.0.0 the repository is the logic
...
for the full repository regression (158 stands + Lean build).
