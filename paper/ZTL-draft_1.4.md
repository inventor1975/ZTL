...
and the frame's own mini-theorems, thirty modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 440 theorems, each one audited individually rather than by
...
line reads otherwise. **440 of 440 clean**, re-run by CI on every push.
