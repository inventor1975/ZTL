...
¬¬-удаление ⊬). Аксиомный статус сертификата: **[propext, Quot.sound]**
— плата за вполне-обоснованную рекурсию движка; Classical.choice не
используется нигде. Ядро (Части I–III) остаётся на пустом списке.
Несформализована лишь эквивалентность движка-на-базисе и «родных»
правил →,⊕,↔ из §5 (их точность покрыта cover_*-теоремами, совпадение
решений — 2490 сверок).
