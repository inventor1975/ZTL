...
def sec5_what_this_cannot_see():
    ...
    print("   invisible here. This file claimed its own risk was an")
    print("   UNDERSTATED blast radius and never an overstated one; that is")
    print("   refuted (containment note, prediction 12). The direction is")
    print("   set by the KIND of missing link — an unrecorded shared origin")
    print("   makes the radius too small, an unrecorded ALTERNATIVE makes it")
    print("   too large — and nothing here can tell which kind is missing,")
    print("   so neither reading may be assumed.")
