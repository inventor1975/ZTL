...
Формализация карантинного флага как конструкции неподвижной точки
(à la Крипке) над таблицами ZTL → кванторные таблó (γ/δ-правила со
знаками P/N) → перенос в Lean следования и таблó (корректность/полнота).
