...
if __name__ == "__main__":
    ...
    print("власть.» Inflation = the sign layer growing while the bit layer")
    print("stands (the unrooted pyramid); prosperity = both layers growing")
    print("together (a receipt per earned bit); and POWER is defined as the")
    print("seat where both flows pay — the mint and the law-held cash-out —")
    print("its honesty decided by which of the two it lives on.")