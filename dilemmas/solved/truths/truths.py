...
if __name__ == "__main__":
    ...
    debunk()
    print()
    print("CAPSTONE: «У каждого своя правда и только ложь общая. Истину или")
    print("добро через тождество имеет право говорить только логика!» —")
    print("truths are")
    print("private because none is a truth; the one thing the disputants")
    print("share is the counterfeit method; and truth-through-identity is")
    print("logic's monopoly: its identity-truths are constants that read no")
    print("atom — honestly empty; and on GOODNESS the sole rightholder is")
    print("silent (value is off logic's axis) — so goodness-through-identity")
    print("is spoken by no one. Goodness is done, not declared; truth is")
    print("earned, not owned.")
