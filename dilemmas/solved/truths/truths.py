...
if __name__ == "__main__":
    ...
    debunk()
    print()
    print("CAPSTONE: «У каждого своя правда и только ложь общая. Истину")
    print("через тождество имеет право говорить только логика!» — truths are")
    ...
    print("atom — honestly empty. A human speaking truth through identity")
    print("about CONTENT sells that emptiness as fact.")
