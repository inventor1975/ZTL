...
kernel C, the rubber operator engine, and the responses to the downstream reviewer's
...
/ a downstream consumer layer that sits ON TOP of the published logic, not inside it.
