...
\begin{theorem}[Fallen laws]\label{thm:fallen}
  \uses{def:ops}\lean{V.lem_needs_ground, V.deMorgan1_needs_ground, V.contraposition_needs_ground, V.imp_refl_needs_ground}\leanok
...
\begin{theorem}[Rules vs laws split]\label{thm:split}
  \uses{thm:mp, thm:fallen}\lean{V.rule_contraposition, V.rule_dn_elim_needs_ground}\leanok
