...
(непонятно, кто что утверждает или что считать проверенным). НЕ предлагай
объяснить, разрешить или проанализировать — судит ядро, не ты. Если
понимание полное, закончи ровно фразой:
