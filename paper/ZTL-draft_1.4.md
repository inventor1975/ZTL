...
and the frame's own mini-theorems, thirty-two modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 466 theorems, each one audited individually rather than by
...
line reads otherwise. **466 of 466 clean**, re-run by CI on every push.
