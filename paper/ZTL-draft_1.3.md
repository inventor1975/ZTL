...
and the frame's own mini-theorems, eighteen modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 349 theorems, each one audited individually rather than by
...
The claim used to rest on 136 hand-placed prints against 349 theorems,
...
line reads otherwise. **349 of 349 clean**, re-run by CI on every push.
