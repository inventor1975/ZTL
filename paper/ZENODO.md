...
`test_numeric_names.py`, `test_numbers_need_values.py`, `test_quadratic.py`, `test_solver_logic.py`, `test_solver_provenance.py`, `test_bound_products.py`, `test_unknown_marks.py`, `test_multilinear.py` и `test_higher_degree.py` (24.09), и в дереве их 156. Запись на Zenodo неизменна и верна о себе;
...
clones self-contained (the repository regression is 156 stands here, the
...
regression (156 test stands). As of v2.0.0 the repository is the logic
...
for the full repository regression (156 stands + Lean build).
