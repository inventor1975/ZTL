...
if __name__ == "__main__":
    ...
    debunk()
    print()
    print("CAPSTONE: «У каждого своя правда — ложь общая. А истина создаётся")
    print("только через знак тождества!» — the day's villain returned as the")
    print("instrument: the lift grants T iff all readings are identical, the")
    print("witness is an '=' with a receipt, grounding forces coincidence —")
    print("and all three imperatives end in one act: the identity sign placed")
    print("on the grounded (verified/decided/chosen → p=v). The lie is the")
    print("same sign unpaid: tautology, witnessless merge, credit. The whole")
    print("difference between truth and lie is whether '=' has been paid for.")
