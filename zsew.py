...
KNOWN UNSOUNDNESS (the downstream reviewer review, 2026-07-21). This sketch joins over
...
if __name__ == "__main__":
    ...
    if st3 == "SEWN":
        ...
        print("      seam returns SEWN on VERDICT EQUALITY. the external reviewer (2026-07-21)")
