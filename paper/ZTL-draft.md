...
Lean-порт стабилизированных утверждений (таблицы, законы, покрытие
правил — всё решается `decide`) → формализация карантинного флага как
конструкции неподвижной точки (à la Крипке) над таблицами ZTL →
кванторные таблó (γ/δ-правила со знаками P/N).
