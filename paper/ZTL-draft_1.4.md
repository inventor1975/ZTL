...
and the frame's own mini-theorems, twenty-eight modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 421 theorems, each one audited individually rather than by
...
line reads otherwise. **421 of 421 clean**, re-run by CI on every push.
