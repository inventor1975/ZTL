...
`downstream/context-closure-001/` measured, over an enumeration, that the kernel's
...
`downstream/context-closure-001/normalize.py` measured that rewriting a claim into
