...
провенансом, выглядя заземлённым. Возражение снялось замером: в `tg_log.jsonl`
МОИХ сообщений НЕТ ВОВСЕ (промерено: Vitaly 1175, arcus18 24, Логик 0) — мои
ответы живут в `sent/` и сюда не попадают. То есть корпус несёт только слова
куратора и Аркадия. Строку `[дата · чат · автор]` всё равно ставим впереди:
...
CHATS = {6783950513: "личный", -5101395964: "группа-Veraxis-ZTL", -5319653310: "третий"}
