...
and the frame's own mini-theorems, twenty-six modules in all — is
formalized in Lean 4 **with an empty axiom list, definitions
included**: 405 theorems, each one audited individually rather than by
...
line reads otherwise. **405 of 405 clean**, re-run by CI on every push.
