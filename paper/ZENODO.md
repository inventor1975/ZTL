...
`test_numeric_names.py`, `test_numbers_need_values.py`, `test_quadratic.py` и `test_solver_logic.py` (24.09), и в дереве их 151. Запись на Zenodo неизменна и верна о себе;
...
clones self-contained (the repository regression is 151 stands here, the
...
regression (151 test stands). As of v2.0.0 the repository is the logic
...
for the full repository regression (151 stands + Lean build).
