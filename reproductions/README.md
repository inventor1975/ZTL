...
- **Tier 1 — maximal weight.** An engineer or researcher with no prior
  connection to ZTL or a downstream consumer, who received nothing beyond the public
  `REPRODUCE.md`.
...
1. **#001** — an unconnected engineer. Requirements: no prior connection to
   ZTL, a downstream consumer, or the authors; given only the public `REPRODUCE.md`; runs
