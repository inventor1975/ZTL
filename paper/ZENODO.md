...
`test_numeric_names.py`, `test_numbers_need_values.py` и `test_quadratic.py` (24.09), и в дереве их 150. Запись на Zenodo неизменна и верна о себе;
...
clones self-contained (the repository regression is 150 stands here, the
...
regression (150 test stands). As of v2.0.0 the repository is the logic
...
for the full repository regression (150 stands + Lean build).
