...
подформул (`cover_*`, decide). Несформализованной остаётся только
учебная склейка (индукция движка по суммарному размеру — стандарт
Hähnle для конечнозначных таблó). Ноль аксиом сохранён.
